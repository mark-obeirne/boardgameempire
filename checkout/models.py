...
class Order(models.Model):
    ...
    county_or_state = models.CharField(max_length=40, blank=True)
    ...
    billing_county_or_state = models.CharField(
    ...
    def save(self, *args, **kwargs):
        """
        Override the original save method to set the order number if not
        already set
        """
    ...
    def update_points_earned(self):
        ...
        self.points_earned = self.lineitems.aggregate(
            Sum("lineitem_points_earned"))["lineitem_points_earned__sum"] or 0
        self.save()
...
class OrderLineItem(models.Model):
    ...
    lineitem_points_earned = models.IntegerField(
